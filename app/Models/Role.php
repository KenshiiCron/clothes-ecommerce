...
class Role extends Model implements RoleContract
{
    ...
    public function displayName(): Attribute
    {
        ...
        return new Attribute(get: fn() => count($name) > 1 ? $name[1] :  $name[0]);
    }
...
//    public function scopeByMedicalOffice($query,$medical_office_id = null)
//    {
//        if (!is_null($medical_office_id))
//        {
//            $query->where('medical_office_id',$medical_office_id);
//        }
//    }
//
