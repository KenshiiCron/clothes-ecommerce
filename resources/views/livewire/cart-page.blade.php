                            ...
                            @forelse($products as $key=>$product)
                                ...
                                <tr class="tf-cart-item file-delete">
                                    <td class="tf-cart-item_product">
                                        <a href="{{route('products.show', $product['details']->id)}}" class="img-box">
                                            <img src="{{$product['details']->image_url}}" alt="img-product">
                                        </a>
                                        <div class="cart-info">
                                    ...
                                    <td class="tf-cart-item_price" cart-data-title="Price">
                                        <div class="cart-price">{{$product['inventory']->price}} DA</div>
                                    </td>
                                    <td class="tf-cart-item_quantity" cart-data-title="Quantity">
                                        <div class="cart-quantity">
                                            <div class="wg-quantity">
                                                    <span wire:click="decreaseQty({{$key}})" class="btn-quantity minus-btn">
                                                ...
                                                <input type="text" wire:model.live="products.{{ $key }}.qty" name="number" readonly>

                                                <span wire:click="increaseQty({{$key}})" class="btn-quantity plus-btn">
