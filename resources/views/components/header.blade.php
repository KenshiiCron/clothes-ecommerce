                                    ...
                                    <div class="row-demo">
                                        <div class="demo-item">
                                            <a href="index.html">
                                                <div class="demo-image position-relative">
                                                    <img class="lazyload" data-src="{{asset('assets/front/images/demo/home-01.jpg')}}" src="{{asset('assets/front/images/demo/home-01.jpg')}}" alt="home-01">
                                        ...
                                        <div class="demo-item">
                                            <a href="home-multi-brand.html">
                                                <div class="demo-image position-relative">
                                                    <img class="lazyload" data-src="{{asset('assets/front/images/demo/home-multi-brand.jpg')}}" src="{{asset('assets/front/images/demo/home-multi-brand.jpg')}}" alt="home-multi-brand">
                                                    <div class="demo-label">
                                                        <span class="demo-new">New</span>
                                        ...
                                        <div class="demo-item">
                                            <a href="home-02.html">
                                                <div class="demo-image position-relative">
                                                    <img class="lazyload" data-src="{{asset('assets/front/images/demo/home-02.jpg')}}" src="{{asset('assets/front/images/demo/home-02.jpg')}}" alt="home-02">
                                                    <div class="demo-label">
                                                        <span class="demo-hot">Hot</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="demo-item">
                                            <a href="home-03.html">
                                                <div class="demo-image">
                                                    <img class="lazyload" data-src="{{asset('assets/front/images/demo/home-03.jpg')}}" src="{{asset('assets/front/images/demo/home-03.jpg')}}" alt="home-03">
                                                </div>
                                        ...
                                        <div class="demo-item">
                                            <a href="home-04.html">
                                                <div class="demo-image">
                                                    <img class="lazyload" data-src="{{asset('assets/front/images/demo/home-04.jpg')}}" src="{{asset('assets/front/images/demo/home-04.jpg')}}" alt="home-04">
                                                </div>
                                        ...
                                        <div class="demo-item">
                                            <a href="home-05.html">
                                                <div class="demo-image">
                                                    <img class="lazyload" data-src="{{asset('assets/front/images/demo/home-05.jpg')}}" src="{{asset('assets/front/images/demo/home-05.jpg')}}" alt="home-05">
                                                </div>
                                        ...
                                        <div class="demo-item">
                                            <a href="home-06.html">
                                                <div class="demo-image position-relative">
                                                    <img class="lazyload" data-src="{{asset('assets/front/images/demo/home-06.jpg')}}" src="{{asset('assets/front/images/demo/home-06.jpg')}}" alt="home-06">
                                                    <div class="demo-label">
                                                        <span class="demo-new">New</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="demo-item">
                                            <a href="home-07.html">
                                                <div class="demo-image">
                                                    <img class="lazyload" data-src="{{asset('assets/front/images/demo/home-07.jpg')}}" src="{{asset('assets/front/images/demo/home-07.jpg')}}" alt="home-07">
                                                </div>
                                        ...
                                        <div class="demo-item">
                                            <a href="home-08.html">
                                                <div class="demo-image">
                                                    <img class="lazyload" data-src="{{asset('assets/front/images/demo/home-08.jpg')}}" src="{{asset('assets/front/images/demo/home-08.jpg')}}" alt="home-08">
                                                </div>
                                        ...
                                        <div class="demo-item">
                                            <a href="home-skincare.html">
                                                <div class="demo-image">
                                                    <img class="lazyload" data-src="{{asset('assets/front/images/demo/home-skincare.jpg')}}" src="{{asset('assets/front/images/demo/home-skincare.jpg')}}" alt="home-skincare">
                                                </div>
                                        ...
                                        <div class="demo-item">
                                            <a href="home-headphone.html">
                                                <div class="demo-image">
                                                    <img class="lazyload" data-src="{{asset('assets/front/images/demo/home-headphone.jpg')}}" src="{{asset('assets/front/images/demo/home-headphone.jpg')}}" alt="home-headphone">
                                                </div>
                                        ...
                                        <div class="demo-item">
                                            <a href="home-giftcard.html">
                                                <div class="demo-image">
                                                    <img class="lazyload" data-src="{{asset('assets/front/images/demo/home-giftcard.jpg')}}" src="{{asset('assets/front/images/demo/home-giftcard.jpg')}}" alt="home-gift-card">
                                                </div>
                                            ...
                                            <div class="collection-item hover-img">
                                                <div class="collection-inner">
                                                    <a href="shop-men.html" class="collection-image img-style">
                                                        <img class="lazyload" data-src="{{asset('assets/front/images/collections/collection-1.jpg')}}" src="{{asset('assets/front/images/collections/collection-1.jpg')}}" alt="collection-demo-1">
                                                    </a>
                                            ...
                                            <div class="collection-item hover-img">
                                                <div class="collection-inner">
                                                    <a href="shop-women.html" class="collection-image img-style">
                                                        <img class="lazyload" data-src="{{asset('assets/front/images/collections/collection-2.jpg')}}" src="{{asset('assets/front/images/collections/collection-2.jpg')}}" alt="collection-demo-1">
                                                    </a>
                                                    <div class="collection-content">
