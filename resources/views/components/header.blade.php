            ...
            <div class="col-xl-6 tf-md-hidden">
                <nav class="box-navigation text-center">
                    <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                        <li class="menu-item">
                            <a href="{{route('home')}}" class="item-link">{{__('navigation.home')}}</a>
                        </li>
                        <li class="menu-item">
                            <a href="{{route('shop')}}" class="item-link">{{__('navigation.shop')}}</a>
                        </li>
                        <li class="menu-item">
                            <a href="{{route('about')}}" class="item-link">{{__('navigation.about')}}</a>
                        </li>
                        <li class="menu-item">
                            <a href="{{route('contact')}}" class="item-link">{{__('navigation.contact')}}</a>
                        </li>
                    </ul>
                </nav>
            </div>
